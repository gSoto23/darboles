    ...
    <div style={{ paddingTop: '100px', minHeight: '80vh', paddingBottom: '100px' }}>
      <main className="page-container fade-in">
        ...
        <section className={`slide-up`} style={{ maxWidth: '800px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', animationDelay: '0.1s' }}>
          ...
          <a href="https://wa.me/50670808613" target="_blank" rel="noopener noreferrer" style={{ padding: '3rem 2rem', background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', textDecoration: 'none', color: 'inherit', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', transition: 'transform 0.2s ease', cursor: 'pointer' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'none'}>
            ...
            <p style={{ color: 'var(--color-muted)', fontSize: '1.1rem' }}>+506 7080-8613</p>
          </a>
